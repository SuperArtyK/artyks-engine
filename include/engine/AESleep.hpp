...
/** @file include/engine/AESleep.hpp
 *  This file contains code for the AESleep module code
...
public:
	...
	/// Class constructor
	/// </summary>
	explicit AESleep() : tp(getsystime)
	{}
...
private:
	...
	///module name
	inline static const std::string m_modulename = "AESleep";
